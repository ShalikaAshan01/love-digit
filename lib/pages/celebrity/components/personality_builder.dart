...
class PersonalityBuilder extends StatelessWidget {
  ...
  const PersonalityBuilder({Key key, @required this.personalities})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    final style = Theme.of(context)
        .textTheme
        .bodyText1
        .copyWith(color: color, fontSize: 12, fontWeight: FontWeight.w400);
    final titleStyle =
              ...
              children: [
                ...
                Container(
                    ...
                    decoration: BoxDecoration(
                        border: Border(
                            left: BorderSide(color: color, width: 0.15))),
                    width: width,
                    child: Column(
                      children: [
                        Icon(
                        ...
                        item.partnerSubtitle == null
                            ? SizedBox.shrink()
                            : Text(
                                item.partnerSubtitle,
                                style: subtitleStyle,
                              )
                      ],
                    )),
